function Contact() {
  return (
    <section className="py-8 md:py-10 lg:py-10 px-6 md:px-10 bg-bg-primary" id="contact">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="card card-glow flex flex-col items-center gap-6 py-14 px-10 text-center">
          ...
          <div className="flex gap-4 flex-wrap justify-center">
            ...
            <a href="https://github.com/PranjaliSengar" target="_blank" rel="noreferrer"
