  ...
  const bubbles = [
    {
      ...
      animation: "bubble-slow",
    },
    {
      size: "40px",
      top: "75%",
      left: "30%",
      color: "bg-blue-muted/20",
      animation: "bubble-fast",
    },
    {
      size: "80px",
      top: "15%",
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 min-h-[75vh] md:min-h-[90vh] lg:min-h-screen">
        <div className="flex flex-col py-8 md:py-12 lg:py-16 px-6 md:px-14 gap-4 bg-bg-primary">
          ...
          <h1 className="font-playfair text-3xl md:text-5xl  text-text-primary leading-snug font-normal">
            Hi, I'm <br />
            <span className="italic text-sage-darktext-4xl md:text-6xl">
              Pranjali Sengar
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <button
              className="bg-sage-dark text-white font-inter text-sm px-6 py-2 rounded-full hover:bg-sage transition-all duration-300"
              onClick={() =>
                document
